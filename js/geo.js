...
function preselectZ(p_key,c_key,t_key) {
	document.getElementById("z1").value = p_key;
    changeZ(1);
	document.getElementById("z2").value = c_key;
	changeZ(2);
	document.getElementById("z3").value = t_key;
}
...
function changeZ(v) {
    var str = "0";
    for (i = 0; i < v; i++) { str += ("_" + (document.getElementById(z[i]).selectedIndex - 1));}
    ;
...
function setupZ() {
    ...
    document.getElementById(z[i]).onchange = new Function("changeZ(" + (i + 1) + ");");
    changeZ(0);
}
