				...
				var temptree = setTimeout(function(){
					...
					$("a", $this).click(function(event){
						...
						if($(this).hasClass("on1")){
							$(".publish").val($(this).text());
							if(!$(this).parent().next().children().children().children().hasClass("on2")){
								$(".accordion").hide();
								$(".publish").removeClass("publish_on");
							}
						}else if($(this).hasClass("on2")){
							var on1 = $(this).parent().parent().parent().prev().children(".on1");
							$(".publish").val(on1.text() + "/" + $(this).text());
							if(!$(this).parent().siblings().length > 0){
								$(".accordion").hide();
						        $(".publish").removeClass("publish_on");
							}
						}else if($(this).hasClass("on3")){
							var on2 = $(this).parent().parent().parent().prev().children(".on2");
							var on1 = on2.parent().parent().parent().prev().children(".on1");
							$(".publish").val(on1.text() + "/" + on2.text() + "/"+ $(this).text());
							$(".accordion").hide();
            				$(".publish").removeClass("publish_on");
						}
				...
				if (tree.size()>0) {
					...
					$(">div>div,>div>a", node).click(function(){//$(">div>div:first
						...
						if (tree.is(":hidden")) {
							...
							if($(this).next().hasClass("on1")){
								$(".publish").val($(this).next().text());
								if(!$(this).parent().next().children().children().children().hasClass("on2")){
									$(".accordion").hide();
									$(".publish").removeClass("publish_on");
								}
							}else if($(this).next().hasClass("on2")){
								var on1 = $(this).parent().parent().parent().prev().children(".on1");
								$(".publish").val(on1.text() + "/" + $(this).next().text());
								if(!$(this).parent().siblings().length > 0){
									$(".accordion").hide();
									$(".publish").removeClass("publish_on");
								}
							}else if($(this).next().hasClass("on3")){
								var on2 = $(this).parent().parent().parent().prev().children(".on2");
								var on1 = on2.parent().parent().parent().prev().children(".on1");
								$(".publish").val(on1.text() + "/" + on2.text() + "/"+ $(this).next().text());
								$(".accordion").hide();
								$(".publish").removeClass("publish_on");
							}
							if (op.icon) {
