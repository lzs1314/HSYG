$(document).ready(function(){
    var $addrlist = $(".so_addr_ul").children("li"),
    $gt2 = $(".so_addr_ul li:gt(2)"),
    $ss_addr_btn = $(".ss_addr_btn"),
    $pwlist = $(".so_pay_way").children("li"),
    $addr_add_span = $(".addr_add_span"),
    ...
    $ss_addr_btn.click(function(){
       ...
       function CheckAddress(){
        ...
        function CheckstreetInfo2(){
            var $streetInfoval = $s3.val();
            var $nextp = $(".regsel").next();
            if($s3.val() == "" || $s3.val() == "市、县级市、县"){
