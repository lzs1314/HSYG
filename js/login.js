$(document).ready(function(){
	...
	$(".placeholder_group").on("focus",".kk_pwd",function(){
		OnFocus($(this), "images/login/blue_pwd.png");
		if ($(this).attr("type") == "text") {
			$(this).remove();
			$(".kk_user").parent().next().find(".kk_img").after('<input type="password" maxlength="20" class="kk_pwd" style="border:1px solid #3aa2e4" />');
			$(".kkcont .placeholder_group .kk_pwd").focus();
		}
		$(".placeholder_group").on("blur",".kk_pwd",function(){
	...
	$(".placeholder_group").on("click",".J_pleft",function(){
       $(".kkcont .placeholder_group .kk_pwd").trigger("focus");
    }) 
	...
	$btn.click(function(){
		...
		if(!$userFlag){
			...
			$(".kkcont .kk_user, .kkcont .kk_pwd,.kkcont .kk_codetext").val("").next().show();
			$(".kkcont .placeholder_group .kk_pwd").remove();
			$(".kk_user").parent().next().find(".kk_img").after('<input type="text" maxlength="20" class="kk_pwd" />');
			return true;
		}
	})
