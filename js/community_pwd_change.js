...
$(document).ready(function(){
    ...
    var $pwd_old = $(".pwd_old"), //原密码
        $pwd_new = $(".pwd_new"),//新密码
        $pwd_new2 = $(".pwd_new2"); //确认新密码

    $(".pwd_btn").click(function(){
        pwd_old = checkReg($pwd_old,"请输入原登录密码","请输入6-20位数字或字母",enReg);
        pwd_new = checkReg($pwd_new,"请输入登录密码","请输入6-20位数字或字母",enReg);
        pwd_new2 = checkReg2($pwd_new,$pwd_new2,"请再次输入登录密码","两次输入密码不一致，请重新输入",enReg);
    ...
    /********焦点获得时**********/
    $pwd_old.focus(function(){   //原密码
        focusInput($(this),$(this).next());
    });
    $pwd_old.next().click(function(){
        clickText($pwd_old,$(this));
    });
